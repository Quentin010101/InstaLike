    ...
    <main class="pt-16 bg-slate-100">
        <div x-data class="bg-transparent ">
            <div class="w-fit mx-auto mt-5 mb-10 px-20 relative">
                ...
                <svg class="w-full absolute -bottom-14 left-0 fill-white" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
