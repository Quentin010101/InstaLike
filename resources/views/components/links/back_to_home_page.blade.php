<div class="p-3 w-40 group cursor-pointer ">
    <a href="{{ url('/') }}" class="flex items-center gap-2">
        <svg class="h-4 w-4 fill-gray-600 group-hover:fill-gray-800 duration-300" version="1.1" id="Capa_1"  xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
        ...
        <span class="flex items-center group-hover:text-gray-800 text-gray-600 duration-300">
            Home page
        </span>
    </a>
</div>